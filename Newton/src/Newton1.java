 ...
 * y, it asks user for a number greater than zero, then outputs the square root.
 *
...
public final class Newton1 {
    ...
    private static double squareRoot(double x) {
        ...
        //repeatedly calculates square root estimate until it is less
        // than or equal to the epsilon
